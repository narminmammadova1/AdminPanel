              ...
              <div className="fixed inset-0 z-40 flex">
                ...
                <aside className="relative w-32 text-[12px] bg-gray-800 bg-opacity-90 py-10 text-white shadow-md">
                  <nav className="space-y-4 mt-6 text-start px-4">
                    <Link href="/admin/users" className="block hover:text-yellow-400" onClick={toggleSidebar}>Пользователи</Link>
                    <Link href="/admin/audio" className="block hover:text-yellow-400" onClick={toggleSidebar}>Аудиофайлы</Link>
                    <Link href="/admin/video" className="block hover:text-yellow-400" onClick={toggleSidebar}>Видеофайлы</Link>
                    <Link href="/admin/mailing" className="block hover:text-yellow-400" onClick={toggleSidebar}>Рассылка</Link>
